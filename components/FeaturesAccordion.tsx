...
const features = [
  {
    title: "Ask questions",
    description:
      "Your child can ask questions about the world and get answers from a kind and polite voice.",
    // type: "video",
  ...
  },
  {
    title: "Encouragement",
    description:
      "Your child will be encouraged to ask more questions and learn about the world.",
    // type: "image",
